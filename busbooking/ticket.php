...
<?php
$pageTitle = "Yamu - Ticket";
$extraStyles = ["https://fonts.googleapis.com/css2?family=Dosis:wght@200..800&display=swap"];
include("header.php");
?>
                            ...
                            <div class="right">
                                <div class="top-box">
                                    <div class="box-heading-ticket">
                                        <img src="images/yamu-logo.png" alt="Yamu Logo" style="height: 80px; width: 150px; ">
                                    </div>
